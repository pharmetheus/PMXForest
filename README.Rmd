...
The latest versions of the vignettes are available in the `BuildVignettesHereDirectory`. Open the Rmd-files in RStudio and click the Knit button to compile. Note that some of the vignettes will take a fair bit of time to compile. 
