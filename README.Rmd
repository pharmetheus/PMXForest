...
To get the latest stable release, please click on the Releases link on the right hand side and then on Tags, and download the latest release package (tar.gz file). This can be installed with the `install.packages` command, e.g.:
