...
$INPUT      NO ID STUDYID TAD TIME AMT RATE ODV DV EVID BLQ DOSE FOOD
            ...
            GENO3 GENO4
$DATA      ../../../Simulations/ModelFRX/DAT-1-MI-PMX-1.csv IGNORE=@
            IGNORE(TYPE.EQN.2) IGNORE(BLQ.EQN.1)
...
$TABLE      NO ID STUDYID TAD TIME AMT RATE ODV DV EVID BLQ DOSE FOOD
            FORM TYPE WT HT AGE SEX RACE ETHNIC GENO SMOK AST ALT BILI
            BMI CRCL NCI NCIL RACEL RACEL2 RACEL3 GENO2 GENO3 GENO4
            CPRED CIPREDI CWRES CIWRES ETAS(1:LAST) NOPRINT ONEHEADER
            FILE=xptab1
