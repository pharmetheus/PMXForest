...
```{r}
dfCovs <- PMXForestPAGE2022::createInputForestData(
...
PMXForestPAGE2022::forestPlot(dfres,plotRelative = F,referenceInfo=NULL,xlb = "Reference subject is a boy in 3rd class",errbartabwidth = c(1,1))
