...
1. The covariate values of interest need to be specified.
2. The model for the primary and/or secondary parameters need to be implemented in R functions.
3. The multivariate distribution of the primary parameters needs to be derived.

With these specifications the data for the Forest plot can be assembled and the Forest plot created. The remaining sections work through each step in turn.
