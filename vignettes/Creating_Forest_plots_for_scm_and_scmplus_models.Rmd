...
# Preliminaries
Some of the functions in this vignette take quite some time to run and the output from these functions are therefore precomputed. To detemine if the precomputed result should be used is governed by the flag `reCompute`
```{r}
reCompute <- TRUE
```
