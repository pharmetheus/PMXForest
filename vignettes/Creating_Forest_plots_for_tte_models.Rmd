...
```{r ForestHR,fig.width=25,fig.asp=.5,out.width="100%"}
plotForestDF(dfresHR,log10x = TRUE,plotRelative = FALSE,strxlab = "Hazard Ratio")
...
plotForestDF(dfresCDF,plotRelative = FALSE,strxlab = "Probability of event")+scale_x_continuous(labels = scales::percent)
