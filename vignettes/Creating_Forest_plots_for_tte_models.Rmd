...
With these specifications the data for the Forest plot can be assembled with `getForestDFSCM` and the Forest plot created. The remaining sections work through each step in turn.
